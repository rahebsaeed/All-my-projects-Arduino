...
const int ULTRASONIC_THRESHOLD_CLOSE = 50; // cm - Distance to trigger aggressive push
const int ULTRASONIC_THRESHOLD_FAR = 80;   // cm - Distance to trigger charging
