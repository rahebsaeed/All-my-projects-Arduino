...
#define TRIGGER_PINL  13  // Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINL     A4  // Arduino pin tied to echo pin on ping sensor.

#define MAX_DISTANCE 100 // Maximum distance we want to ping for (in centimeters). Maximum sensor distance is rated at 400-500cm.

#define TRIGGER_PINF  7  // Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINF     8  // Arduino pin tied to echo pin on ping sensor.
...
void setup() {
  ...
  pinMode(9, OUTPUT);  // EN-A (PWM)
  pinMode(10, OUTPUT); // EN-B (PWM)
