//   Cas3      O  Obstcle under Ultrasonic Front                                                                  
...
#define FRONT_SPEED_THRESHOLD 80.0 // cm
...
void loop() {
  ...
  if(Distance_F < MIN_OBSTACLE_DISTANCE ){
    ...
    if(irLeft < OBSTACLE_MAX and irLeft > OBSTACLE_MIN && irRight < OBSTACLE_MAX && irRight > OBSTACLE_MIN ){
